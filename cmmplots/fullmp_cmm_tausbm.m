...
titles = {
   sprintf(['(a) \\color[rgb]{%s}AMP\\color[rgb]{%s} vs. \\color[rgb]{%s}bin', ...
   '\\color[rgb]{%s}  TAU SBM , D_t = 80 \\mum'], amp_color_str, textclr_rgb, bin_color_str,...
   textclr_rgb), ...
   sprintf(['(b) \\color[rgb]{%s}AMP\\color[rgb]{%s} vs. \\color[rgb]{%s}bin', ...
   '\\color[rgb]{%s}  TAU SBM , D_t = 50 \\mum'], amp_color_str, textclr_rgb, bin_color_str,...
   textclr_rgb), ...
   sprintf(['(c) \\color[rgb]{%s}bin\\color[rgb]{%s}-TAU vs. ',...
...
annotation('rectangle', [.465 .942 .105 .03],'EdgeColor',textclr,'linewidth',2)
annotation('rectangle', [.466 .590 .105 .03],'EdgeColor',textclr,'linewidth',2)
annotation('textbox', [.464 .943 .105 .03],'EdgeColor','none','color',textclr, ...
   'String','¦','FontSize',24,'HorizontalAlignment','center')
annotation('textbox', [.465 .592 .105 .03],'EdgeColor','none','color',textclr, ...
   'String','¦','FontSize',24,'HorizontalAlignment','center')
annotation('line',[.641 .670], [.944 .944],'linewidth',2,'color',textclr)
annotation('line',[.641 .670], [.592 .592],'linewidth',2,'color',textclr)
