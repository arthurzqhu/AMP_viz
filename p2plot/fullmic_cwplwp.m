...
exportgraphics(gcf,['plots/p2/', mconfig, ' ' bintype{TAUorSBM} ' cwplwp rank sandwich.pdf'])
saveas(gcf,['plots/p2/', mconfig, ' ' bintype{TAUorSBM} ' cwplwp rank sandwich.fig'])
