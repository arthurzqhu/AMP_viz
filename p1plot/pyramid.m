...
set(l,'Position',[0.73 0.85 0.07 0.07],'FontSize',12);

str1 = {'CWP: ', 'RWP: ', 'LWP: ', 'N\fontsize{10}c\fontsize{14}: ', ...
   'N\fontsize{10}r\fontsize{14}: ', ...
   't\fontsize{10}1/2, c\fontsize{14}: ', ...
   'MSP: '};
...
annotation('textbox',[0.07 0.771 0.20 0.155],'String', str1,...
           'FontSize',14,'edgecolor','none')
annotation('textbox',[0.12 0.771 0.20 0.155],'String', str2,...
           'FontSize',14,'edgecolor','none')
annotation('rectangle',[0.07 0.771 0.19 0.155])

exportgraphics(gcf,['plots/p1/pyramid_onlyweighted.jpg'],'Resolution',300)
