...
title(tl,['Collision-coalescence only (unified category AMP) - ' ...
   indvar_ename_set{ivar} indvar_units_set{ivar}],'fontsize',20,'fontweight','bold')
end
exportgraphics(gcf,['plots/p1/collonly_4m_halflife.png'],'Resolution',300)
