...
%          pause;
         ...
         for ivar=1:nvar
            ...
            sedsum.(var_name_output{ivar})(1,(its-1)*2+1)=...
               find(amp_rain_path{ivar}<rain_i(ivar)*.75,1,'first');
            sedsum.(var_name_output{ivar})(2,(its-1)*2+1)=...
               find(amp_rain_path{ivar}<rain_i(ivar)*.50,1,'first');
            sedsum.(var_name_output{ivar})(3,(its-1)*2+1)=...
               find(amp_rain_path{ivar}<rain_i(ivar)*.25,1,'first');
            sedsum.(var_name_output{ivar})(4,(its-1)*2+1)=...
               find(amp_rain_path{ivar}<rain_i(ivar)*.1,1,'first');
            
            sedsum.(var_name_output{ivar})(1,(its-1)*2+2)=...
               find(bin_rain_path{ivar}<rain_i(ivar)*.75,1,'first');
            sedsum.(var_name_output{ivar})(2,(its-1)*2+2)=...
               find(bin_rain_path{ivar}<rain_i(ivar)*.50,1,'first');
            sedsum.(var_name_output{ivar})(3,(its-1)*2+2)=...
               find(bin_rain_path{ivar}<rain_i(ivar)*.25,1,'first');
            sedsum.(var_name_output{ivar})(4,(its-1)*2+2)=...
               find(bin_rain_path{ivar}<rain_i(ivar)*.1,1,'first');
         end
